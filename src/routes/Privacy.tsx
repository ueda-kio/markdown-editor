...
import { markdownViwerStyle } from '../style/markdownViwerStyle';
...
const Privacy = () => {
	return (
		<Box css={[markdownViwerStyle, style]} mt="5" pb="10" flexGrow="1" overflow="auto">
			<div>
				<div>
					<div>
						<p>Privacy Policy for Editor App</p>
					</div>
				</div>
				<div>
					<div>
						<div>
							...
							<ul>
								...
								<li>
									<p>
										...
										&quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Editor App.
									</p>
								</li>
								<li>
									<p>
								...
								<li>
									<p>
										<strong>Website</strong> refers to Editor App, accessible from{' '}
										<a href="https://markdown-editor-57417.web.app/" rel="external nofollow noopener" target="_blank">
											https://markdown-editor-57417.web.app/
										</a>
									</p>
								</li>
								<li>
							...
							<ul>
								<li>By email: gibson511511@gmail.com</li>
							</ul>
						</div>
					</div>
				</div>
